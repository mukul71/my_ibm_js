const books = []; // Define an array to store books
...
function addBooks() {
    ...
    if (bookName && authorName && bookDescription && !isNaN(pagesNumber)) {
        ...
        books.push(book); // Push the book object into the books array
        showBooks(); // Call the showBooks function to display the updated list
